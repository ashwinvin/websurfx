    ...
    html!(
        ...
        main class="about-container"{
         article {
             ...
             ul{strong{"Privacy focused"}" - Anvesh does not track, store or sell your search data. Your privacy is our priority."}
             ...
             ul{strong{"Highly customizable"}" - Anvesh comes with 9 built-in color themes and supports creating custom themes effortlessly."}
         }

         h3{"Devoloped by: "{a href="https://github.com/neon-mmd/anvesh"{"Anvesh team"}}}
        }
        (footer())
    )
}
